...
// Copyright (c) 2009-2013 The Kawaiicoin developers
// Distributed under the MIT/X11 software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef Kawaiicoin_BIGNUM_H
#define Kawaiicoin_BIGNUM_H
...
public:
    ...
    //
    // Kawaiicoin only uses this "compact" format for encoding difficulty
