 ...
 * between Kawaiicoind, and Kawaiicoin-qt and non-server tools.
*/
...
void Shutdown()
{
    ...
    RenameThread("Kawaiicoin-shutoff");
...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += HelpMessageOpt("-conf=<file>", strprintf(_("Specify configuration file (default: %s)"), Kawaiicoin_CONF_FILENAME));
    if (mode == HMM_KawaiicoinD)
    {
#if HAVE_DECL_DAEMON
...
#ifndef WIN32
    strUsage += HelpMessageOpt("-pid=<file>", strprintf(_("Specify pid file (default: %s)"), Kawaiicoin_PID_FILENAME));
#endif
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/Kawaiicoin/Kawaiicoin>";
    const std::string URL_WEBSITE = "<https://Kawaiicoin.co>";
...
void ThreadImport(std::vector<boost::filesystem::path> vImportFiles)
{
    ...
    RenameThread("Kawaiicoin-loadblk");
...
/** Sanity checks
 *  Ensure that Kawaiicoin is running in a usable environment with all
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Kawaiicoin version %s\n", FormatFullVersion());
}
...
static bool LockDataDirectory(bool probeOnly)
{
    ...
    // Make sure only a single Kawaiicoin process is using the data directory.
...
bool AppInitMain(boost::thread_group& threadGroup, CScheduler& scheduler)
{
    ...
    LogPrintf("Using config file %s\n", GetConfigFile(GetArg("-conf", Kawaiicoin_CONF_FILENAME)).string());
