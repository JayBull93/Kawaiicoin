...
public:
    CMainParams() {
        strNetworkID = "main";
        //consensus.nSubsidyHalvingInterval = 210000; - kwi
        ...
        /** Current Kawaiicoin 2017 Difficulty Adjustment Code & Block Target. See explanation here: 
        https://github.com/Kawaiicoin/Kawaiicoin-old/pull/36 
        https://github.com/Kawaiicoin/Kawaiicoin-old/pull/15
        ...
        **/
        ...
        // Old 1% monthly kwi Reward before 15 secon block change
        consensus.patchBlockRewardDuration = 10080; //10080; - No longer used
        //4 blocks per min, x60 minutes x 24hours x 14 days = 80,160 blocks for 0.5% reduction in kwi reward supply - No longer used
        ...
        // Kawaiicoin Hard Fork Block Heights
        ...
        vSeeds.push_back(CDNSSeedData("Kawaiicoin.co", "seed.Kawaiicoin.co"));
...
public:
    CTestNetParams() {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        //assert(consensus.hashGenesisBlock == uint256S("0xb5dca8039e300198e5fe7cd23bdd1728e2a444af34c447dbd0916fa3430a68c2"));
        //assert(genesis.hashMerkleRoot == uint256S("0x4a5e1e4baab89f3a32518a88c31bc87f618f76673e2cc77ab2127b7afdeda33b"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.push_back(CDNSSeedData("Kawaiicoinwiki.com", "testnet-seed.Kawaiicoinwiki.com"));
