...
#ifndef Kawaiicoin_WALLET_WALLET_H
#define Kawaiicoin_WALLET_WALLET_H
...
public:
     ...
     * on this Kawaiicoin node, and set to 0 for transactions that were created
...
#endif // Kawaiicoin_WALLET_WALLET_H
